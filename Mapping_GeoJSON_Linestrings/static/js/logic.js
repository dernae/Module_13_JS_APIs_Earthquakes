...
let airportData = "https://raw.githubusercontent.com/dernae/Module_13_JS_APIs_Earthquakes/Mapping_Earthquakes/majorAirports.json";
...
L.geoJson(data, {
  pointToLayer: function(feature, latlng) {
    ...
    //add city to the popup marker 
    .bindPopup("<h2>" + "Airport code: " + feature.properties.faa + "</h2>" + "<h2>" + "_________________________" + "</h2>"+ "<h2>" + "Airport name: " + feature.properties.name + "</h2>" )
  }
